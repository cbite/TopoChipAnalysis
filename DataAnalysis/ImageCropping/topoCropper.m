...
%%%%%%%%%%%USER PARAMETERS%%%%%%%%%%%%%
%define screen name
screen_name =input('Set the Screen name: ')
...
rotation_angle=input('Give the rotation angle, [positive=counterclockwise rotation, negative=clockwise rotaion')
